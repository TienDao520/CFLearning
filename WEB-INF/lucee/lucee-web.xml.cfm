<?xml version="1.0" encoding="ISO-8859-1" standalone="no"?><cfLuceeConfiguration salt="9EF9FB04-5C16-4D4F-9CBDE06401CCB515" version="5.3">
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" always-set-timeout="true" blob="false" class="com.mysql.cj.jdbc.Driver" clob="false" connectionLimit="-1" connectionTimeout="1" custom="characterEncoding=UTF-8&amp;serverTimezone=America%2FNew_York&amp;maxReconnects=3" database="customerdata" dbdriver="MySQL" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" id="mysql" liveTimeout="15" metaCacheTimeout="60000" name="crms" param-delimiter="&amp;" param-leading-delimiter="?" param-separator="=" password="encrypted:c5548730cc12c0d57f351ee9076a5bd1b3f1abcee08e72211d0181523f125504" port="3306" storage="false" username="tiendao" validate="false"/><data-source allow="511" always-set-timeout="true" blob="false" class="com.mysql.cj.jdbc.Driver" clob="false" connectionLimit="-1" connectionTimeout="1" custom="characterEncoding=UTF-8&amp;serverTimezone=America%2FNew_York&amp;maxReconnects=3" database="test" dbdriver="MySQL" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" id="mysql" liveTimeout="15" metaCacheTimeout="60000" name="test" param-delimiter="&amp;" param-leading-delimiter="?" param-separator="=" password="encrypted:27c86b525194265eb50d6e301d971d67ff5291da5eb6e2d5c4a822ed7d29b40f" port="3306" storage="false" username="root" validate="false"/></data-sources>
	<mode develop="false"/>
